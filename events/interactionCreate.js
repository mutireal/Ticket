            ...
            selectMenu.addOptions([
                {
                    emoji: '🧑‍💻',
                    label: 'Tasarım',
                    description: 'Özel Tasarım Yaptırmak İçin Başvuru Bileti Açın',
                    value: 'ticket31'
                },
                {
                    emoji: '🤖',
                    label: 'Bot',
                    description: 'Bıt Yaptırmak İçin Başvuru Bileti Açın',
                    value: 'ticket31_şikayet'
                },
                {
                    emoji: '🫶',
                    label: 'İstek / Şikayet / Destek',
                    description: 'İstek / Şikayet / Destek Bildirimek İçin Başvuru Bileti Açın',
